...
/**
 * Custom setting for Elegance theme.
 */
function elegance_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h4>Merci d\'utiliser le théme Elegance</h4><p>Elegance is a free Drupal 9 & 10 theme designed and developed by <a href="https://drupar.com" target="_blank">Drupar.com</a></p>'),
    '#group' => 'elegance',
  ];
  // layout tab.
  $form['layout'] = [
  ...
  // Upgrade to elegancepro tab.
  $form['upgrade'] = [
    '#type'  => 'details',
    '#title' => t('Upgrade to MahiPro'),
    '#description'  => t("<h4>Upgrade To MahiPro For $29 Only.</h4><p><a href='https://drupar.com/theme/mahi' target='_blank'>Purchase MahiPro</a> || <a href='https://demo.drupar.com/mahipro/' target='_blank'>MahiPro Demo</a></p><p>$elegancepro</p>"),
    '#group' => 'elegance',
  ];
  // General
  ...
  $form['layout']['layout_container']['container_width'] = [
    '#type'          => 'number',
    '#default_value' => theme_get_setting('container_width', 'elegance'),
  ...
  $form['layout']['layout_header']['header_width'] = [
    ...
    '#default_value' => theme_get_setting('header_width', 'elegance'),
  ];
  // Layout -> Main Layout
  ...
  $form['layout']['layout_main']['main_width'] = [
    ...
    '#default_value' => theme_get_setting('main_width', 'elegance'),
  ];
  ...
  $form['layout']['layout_footer']['footer_width'] = [
    ...
    '#default_value' => theme_get_setting('footer_width', 'elegance'),
  ];
  // Color
  ...
  $form['social']['all_icons']['all_icons_show'] = [
    ...
    '#default_value' => theme_get_setting('all_icons_show', 'elegance'),
  ...
  $form['social']['facebook']['facebook_url'] = [
    ...
    '#default_value' => theme_get_setting('facebook_url', 'elegance'),
  ];
  // Twitter.
  $form['social']['twitter'] = [
    '#type'        => 'details',
  ...
  $form['social']['twitter']['twitter_url'] = [
    ...
    '#default_value' => theme_get_setting('twitter_url', 'elegance'),
  ];
  // Instagram.
  ...
  $form['social']['instagram']['instagram_url'] = [
    ...
    '#default_value' => theme_get_setting('instagram_url', 'elegance'),
  ];
  // Linkedin.
  ...
  $form['social']['linkedin']['linkedin_url'] = [
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'elegance'),
  ];
  // YouTube.
  $form['social']['youtube'] = [
    '#type'        => 'details',
  ...
  $form['social']['youtube']['youtube_url'] = [
    ...
    '#default_value' => theme_get_setting('youtube_url', 'elegance'),
  ];
  // Vimeo.
  $form['social']['vimeo'] = [
    '#type'        => 'details',
  ...
  $form['social']['vimeo']['vimeo_url'] = [
    ...
    '#default_value' => theme_get_setting('vimeo_url', 'elegance'),
  ];
  // Social -> vk.com url.
  $form['social']['vk'] = [
    '#type'        => 'details',
  ...
  $form['social']['vk']['vk_url'] = [
    ...
    '#default_value' => theme_get_setting('vk_url', 'elegance'),
  ];
  // Social -> whatsapp.
  ...
  $form['social']['whatsapp']['whatsapp_url'] = [
    ...
    '#default_value' => theme_get_setting('whatsapp_url', 'elegance'),
  ];
  // Social -> github.
  $form['social']['github'] = [
    '#type'        => 'details',
  ...
  $form['social']['github']['github_url'] = [
    ...
    '#default_value' => theme_get_setting('github_url', 'elegance'),
  ];
  // Social -> telegram.
  ...
  $form['social']['telegram']['telegram_url'] = [
    ...
    '#default_value' => theme_get_setting('telegram_url', 'elegance'),
  ];
  // Homepage slider
  ...
  $form['slider']['slider_show_section']['slider_show'] = [
    ...
    '#default_value' => theme_get_setting('slider_show', 'elegance'),
  ...
  $form['slider']['slider_image_section']['slider_images'] = [
    ...
    '#default_value'  => theme_get_setting('slider_images', 'elegance'),
  ...
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code', 'elegance'),
  ...
  $form['content_tab']['shortcode'] = [
    '#type'        => 'details',
    '#title'       => t('Shortcodes'),
    '#description' => t('<p>Mahi theme has some custom shortcodes. You can create some styling content using these shortcodes.</p><p>Please visit this tutorial page for details. <a href="https://drupar.com/node/2636" target="_blank">Shortcodes in elegance theme</a>.</p>'),
    '#group' => 'content_tab',
  ];
  // content -> comment
  ...
  $form['content_tab']['demo_content'] = [
    ...
    '#description' => t('<p>Content of theme Mahi demo site is available on our website.</p><p><a href="https://demo.drupar.com/elegance/" target="_blank">Mahi Theme Demo</a> | <a href="https://drupar.com/node/2638/" target="_blank">Get Demo Site Content</a></p>'),
    '#group' => 'content_tab',
  ];
  ...
  $form['content_tab']['font_tab']['font_section']['font_src'] = [
    ...
    '#default_value' => theme_get_setting('font_src', 'elegance'),
  ...
  $form['content_tab']['icon_tab']['fontawesome5_sec']['fontawesome_five'] = [
    ...
    '#default_value' => theme_get_setting('fontawesome_five', 'elegance'),
  ...
  $form['content_tab']['icon_tab']['fontawesome6_sec']['fontawesome_six'] = [
    ...
    '#default_value' => theme_get_setting('fontawesome_six', 'elegance'),
  ...
  $form['content_tab']['icon_tab']['bootstrap_icons']['bootstrapicons'] = [
    ...
    '#default_value' => theme_get_setting('bootstrapicons', 'elegance'),
  ...
  $form['content_tab']['comment']['comment_section']['highlight_author_comment'] = [
    ...
    '#default_value' => theme_get_setting('highlight_author_comment', 'elegance'),
  ...
  $form['footer']['scrolltotop']['scrolltotop_on'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_on', 'elegance'),
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#default_value' => theme_get_setting('copyright_text', 'elegance'),
  ...
  $form['insert_codes']['head']['insert_head'] = [
    '#type'          => 'fieldset',
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/elegancepro" target="_blank">Buy MahiPro for $29 only.</a>'),
  ];
  ...
  $form['insert_codes']['css']['css_custom']['css_extra'] = [
    ...
    '#default_value' => theme_get_setting('css_extra', 'elegance'),
  ...
  $form['insert_codes']['css']['css_code'] = [
    ...
    '#default_value' => theme_get_setting('css_code', 'elegance'),
